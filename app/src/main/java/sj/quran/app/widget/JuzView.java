...
public class JuzView extends Drawable {
    ...
    public JuzView(Context context, int type, String overlayText) {
        final int circleColor = ContextCompat.getColor(context, R.color.colorApp);
        final int circleBackground = ContextCompat.getColor(context, R.color.colorAppRipple);
        ...
        if (!TextUtils.isEmpty(this.overlayText)) {
            final int textColor = ContextCompat.getColor(context, R.color.colorWhite);
